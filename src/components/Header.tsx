      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-8">
        ...
        <div className="flex-1 text-center sm:text-left">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-effect-strong border border-primary/30 text-[10px] font-black mb-4 uppercase tracking-widest shadow-elegant hover:shadow-glow transition-smooth">
            ...
            <span className="text-gradient">Live Documentation • v3.0</span>
          </div>
          ...
          <div className="flex flex-wrap gap-3 text-sm font-sans justify-center sm:justify-start">
            ...
            >
              ...
              <svg className="relative w-4 h-4 text-primary-foreground z-10" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="group relative inline-flex items-center gap-2 px-6 py-3 rounded-xl border-2 border-primary/50 glass-effect-strong font-bold shadow-card hover:shadow-elegant transition-smooth hover:scale-105 hover:border-primary overflow-hidden"
            >
              <div className="absolute inset-0 gradient-primary opacity-0 group-hover:opacity-10 transition-smooth"></div>
              <svg className="relative w-4 h-4 text-primary z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
              </svg>
              <span className="relative text-gradient z-10">Neext Code</span>
            </button>
          </div>
        </div>
      </div>
