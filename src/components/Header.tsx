    ...
    <header className="mb-16 animate-fade-in">
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-8">
        ...
        <div className="flex-1 text-center sm:text-left">
          ...
          <p className="text-base max-w-3xl font-sans leading-relaxed mb-6" style={{backgroundImage: "linear-gradient(135deg, #00d4ff 0%, #a78bfa 100%)", backgroundClip: "text", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", fontWeight: "600"}}>
          ...
          <div className="flex flex-col gap-3 text-sm font-sans items-center sm:items-start">
            ...
            <div className="flex flex-wrap gap-3 justify-center sm:justify-start sm:ml-8">
              ...
              >
                ...
                <svg className="relative w-4 h-4 text-white z-10" fill="currentColor" viewBox="0 0 24 24">
